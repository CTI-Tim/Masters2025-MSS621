...
namespace MSSXpanel.MainPage
{
    ...
    public partial interface IMediaControl 
    {
        ...
        void MediaControl_Visibility_fb(MediaControlBoolInputSigDelegate callback);

        /// <summary>
        /// MediaControl.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void MediaControl_Visibility_fb(bool digital);
    }
    ...
    internal partial class MediaControl : IMediaControl, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: MainPage.MediaControl.Visibility_fb
                /// MediaControl.Visibility
                /// </summary>
                public const uint MediaControl_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void MediaControl_Visibility_fb(MediaControlBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.MediaControl_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void MediaControl_Visibility_fb(bool digital)
        {
            MediaControl_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
