...
namespace MSSXpanel.MainPage
{
    ...
    /// NvxInfo
    /// </summary>
    public partial interface INvxInfo 
    {
        ...
        void NvxInfo_Visibility_fb(NvxInfoBoolInputSigDelegate callback);

        /// <summary>
        /// NvxInfo.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void NvxInfo_Visibility_fb(bool digital);
    }
    ...
    internal partial class NvxInfo : INvxInfo, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: MainPage.NvxInfo.Visibility_fb
                /// NvxInfo.Visibility
                /// </summary>
                public const uint NvxInfo_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void NvxInfo_Visibility_fb(NvxInfoBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.NvxInfo_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void NvxInfo_Visibility_fb(bool digital)
        {
            NvxInfo_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
