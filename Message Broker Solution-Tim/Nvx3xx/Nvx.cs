...
namespace Nvx3xx
{
    public class Nvx
    {
        ...
        /*
         * Did you know that you can add summary's for Properties?  
         * This way when y ou hover over that property it will display the text in your summary to assist
         * programmers that use your library code in their chosen IDE.
         * When it's a single line I like to prepend it 10th #### to mazke it stand out to the programmer.
         * a single line of text can get lost in the definition popup on a 4K screen
         */

        /// <summary>
        /// ####  Standard NVX Com Port. Preset in the class to 9600,N,8,1
        /// </summary>
        public ComPort NvxComPort;
        /// <summary>
        /// ####  Standard IR Port hardcoded to IR port 1
        /// </summary>
        public IROutputPort NvxIrPort;
        ...
        /// <summary>
        ///     Creates a DmNvx351 for use in the program. Auto Initiation is enabled, leds are set to on
        ///     Automatic input routing is disabled.
        /// </summary>
        /// <param name="ipId">IpID for the device to use</param>
        /// <param name="mode">Initial Mode the Device is set to with the program starts. Example: Nvx.Emode.Rx</param>
        /// <param name="cs">Control System this Device is attached to</param>
        public Nvx(uint ipId, EMode mode, CrestronControlSystem cs)
        {
             ...
             */
            NvxComPort = _myNvx.ComPorts[1]; // Crestron is 1 based  don't forget.
            NvxComPort.SetComPortSpec(
                ...
                false);
            NvxComPort.SerialDataReceived += MyComPort_SerialDataReceived;

            // Setup IR port
            NvxIrPort = _myNvx.IROutputPorts[1];
        }
        ...
        ///     Send the string as bytes do not worry about Encoding
        ///     Crestron will accept and send all 256 states as bytes
        /// </summary>
        /// <param name="tx">CEC command string as bytes to send</param>
        /// <param name="input">Input Enum to select source.  Example: Nvx.Esource.Hdmi1</param>
        public void CecInputSend(string tx, uint input)
        {
            ...
            // Just be careful as Crestron ASCII on devices is not the same as C# ASCII.
